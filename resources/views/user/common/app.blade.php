...
<head>
    ...
    <meta property="og:description"
          content="Discover Unseenstay: Book resorts, homestays, and tour packages for your next adventure. Explore unique accommodations and plan your perfect getaway with us."/>
    ...
    <link href="{{ asset('https://fonts.googleapis.com/css?family=Poppins:200,300,400,500,600,700') }}"
          rel="stylesheet">
    <link href="{{ asset('https://fonts.googleapis.com/css?family=Playfair+Display:400,400i,700,700i') }}"
          rel="stylesheet">
