        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center"
                     style="background-image: url(user/images/jk.jpg);">
                ...
                <div class="col-md-7 py-5 wrap-about pb-md-5 ftco-animate">
                    ...
                    <div class="pb-md-5">
                        <p>Welcome to Unseenstay, where luxury meets seclusion, and every moment is a hidden gem waiting
                            to be discovered. Nestled in the heart of nature, our resort is a haven of tranquility,
                            promising an escape from the ordinary. As you step into the embrace of Unseenstay, you'll
                            find a harmonious blend of opulence and the untouched beauty of the surroundings. Our
                            accommodations are designed to provide a retreat for the soul, allowing you to unwind in
                            style and comfort. Whether you're seeking a romantic getaway, a family adventure, or a solo
                            retreat, Unseenstay is your sanctuary. Immerse yourself in the unseen wonders that await,
                            where each stay is a unique and unforgettable experience, leaving you refreshed,
                            rejuvenated, and longing to return to the hidden paradise we proudly call home. </p>
                        <ul class="ftco-social d-flex">
                            <li class="ftco-animate"><a href="https://www.facebook.com/p/THE-UNSEEN-100083043322137/"
                                                        target="_blank"><span class="icon-facebook"></span></a></li>
                            <li class="ftco-animate"><a href="mailto:unseenstay@gmail.com?subject=Hi%20How%20Here"
                                                        target="_blank"><span class="fas fa-envelope"></span></a></li>
                            <li class="ftco-animate"><a href="https://www.instagram.com/unseenstay/"
                            ...
                            <li>
                                <a href="https://wa.me/+919188165352?text=Hello!%20I%20have%20a%20question%20and%20could%20use%20your%20assistance.%20Can%20you%20please%20help?"
                                   target="_blank"><span class="fa-brands fa-whatsapp"></span></a></li>
                                    ...
                                    <div class="item">
                                        <div class="testimony-wrap py-4 pb-5">
                                            <div class="user-img mb-4"
                                                 style="background-image: url('images/<?php echo $review->image; ?>');">
